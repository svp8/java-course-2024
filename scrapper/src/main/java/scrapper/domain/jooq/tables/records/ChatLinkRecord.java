...
public class ChatLinkRecord extends UpdatableRecordImpl<ChatLinkRecord> implements Record2<Long, Integer> {
    ...
    @Override
    @NotNull
    public ChatLinkRecord values(@NotNull Long value1, @NotNull Integer value2) {
        value1(value1);
        value2(value2);
        return this;
    }
    ...
    public ChatLinkRecord(@NotNull Long chatId, @NotNull Integer linkId) {
        super(ChatLink.CHAT_LINK);
     ...
     * Create a detached, initialised ChatLinkRecord
     */
    public ChatLinkRecord(scrapper.domain.jooq.tables.pojos.ChatLink value) {
        super(ChatLink.CHAT_LINK);
