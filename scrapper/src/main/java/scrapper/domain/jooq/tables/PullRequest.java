...
public class PullRequest extends TableImpl<PullRequestRecord> {
     ...
     */
    public final TableField<PullRequestRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>PULL_REQUEST.TITLE</code>.
     */
    public final TableField<PullRequestRecord, String> TITLE = createField(DSL.name("TITLE"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>PULL_REQUEST.LINK_ID</code>.
     */
    public final TableField<PullRequestRecord, Integer> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.INTEGER.nullable(false), this, "");
