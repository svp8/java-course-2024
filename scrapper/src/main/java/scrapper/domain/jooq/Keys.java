...
public class Keys {
    ...
    public static final UniqueKey<AnswerRecord> ANSWER_PKEY =
        Internal.createUniqueKey(Answer.ANSWER, DSL.name("ANSWER_PKEY"), new TableField[] {Answer.ANSWER.ID}, true);
    public static final UniqueKey<BranchRecord> BRANCH_PKEY = Internal.createUniqueKey(Branch.BRANCH,
        DSL.name("BRANCH_PKEY"),
        new TableField[] {Branch.BRANCH.NAME, Branch.BRANCH.LINK_ID},
        true
    );
    ...
    public static final UniqueKey<ChatLinkRecord> CHAY_LINK_PKEY = Internal.createUniqueKey(ChatLink.CHAT_LINK,
        DSL.name("CHAY_LINK_PKEY"),
        new TableField[] {ChatLink.CHAT_LINK.CHAT_ID, ChatLink.CHAT_LINK.LINK_ID},
        true
    );
    public static final UniqueKey<CommentRecord> COMMENT_PKEY = Internal.createUniqueKey(Comment.COMMENT,
        DSL.name("COMMENT_PKEY"),
        new TableField[] {Comment.COMMENT.ID},
        true
    );
    ...
    public static final UniqueKey<LinkRecord> CONSTRAINT_23 =
        Internal.createUniqueKey(Link.LINK, DSL.name("CONSTRAINT_23"), new TableField[] {Link.LINK.NAME}, true);
    public static final UniqueKey<PullRequestRecord> PULL_REQUEST_PKEY =
        Internal.createUniqueKey(PullRequest.PULL_REQUEST,
            DSL.name("PULL_REQUEST_PKEY"),
            new TableField[] {PullRequest.PULL_REQUEST.ID},
            true
        );
    ...
    public static final ForeignKey<AnswerRecord, LinkRecord> CONSTRAINT_73 = Internal.createForeignKey(Answer.ANSWER,
        DSL.name("CONSTRAINT_73"),
        new TableField[] {Answer.ANSWER.LINK_ID},
        Keys.CONSTRAINT_2,
        new TableField[] {Link.LINK.ID},
        true
    );
    public static final ForeignKey<BranchRecord, LinkRecord> CONSTRAINT_7 = Internal.createForeignKey(Branch.BRANCH,
    ...
    public static final ForeignKey<CommentRecord, LinkRecord> CONSTRAINT_6 = Internal.createForeignKey(Comment.COMMENT,
        DSL.name("CONSTRAINT_6"),
        new TableField[] {Comment.COMMENT.LINK_ID},
        Keys.CONSTRAINT_2,
        new TableField[] {Link.LINK.ID},
        true
    );
    public static final ForeignKey<PullRequestRecord, LinkRecord> CONSTRAINT_5 =
        Internal.createForeignKey(PullRequest.PULL_REQUEST,
            DSL.name("CONSTRAINT_5"),
            new TableField[] {PullRequest.PULL_REQUEST.LINK_ID},
            Keys.CONSTRAINT_2,
            new TableField[] {Link.LINK.ID},
            true
        );
